...
|-----------:|----------------------------------------|-------------------------------------|-------------------------------|
| Тсертвамм  | Сате? Жаме? (Кто?/Что?)                | Саира / Человека                    | базовая форма                 |
| Кавартрамм | Сатка? Жамка? (Кого?/Чего?)            | Саирка / Человека                   | -ка / -га / ак / ка           |
| Эттамм     | Сатэт? Жатэт? ((для) Кого/Чего)        | Арэт / Мне (для меня)               | -эт / -йэт                    |
| Зантамм    | Ирсатта? Иржамта? (Кем?/Чем?)          | Ирйарта / мной . Ирйороста / Им     | префикс ир(й)- +окончание -та |
...
| **9 200 100** | зордар.рицэт-чар.цэт                       | 9 млрд.200 тыс.100 |
...
- Образуются с помощью частички "руй", которая согласуется с существительными.
> От неё также образуются вопросы "Который?", "Какой по счёту?": "Руйлу" и "Р"

**Примеры:**
- руй-аб' — первый
- руй-ри — второй
- руй-ттикитти — тридцать третий
- руй-зорцэт-зорки-зор — девятьсот девяносто девятый

- фа **руйка-шыс** сэчпиника
    → в пятом классе
    > `фа [-ка]` - в каком? ; `руйка-шыс` - "пятом" ; `сэчпиника` - "классе"
