...
- `'` используется двумя образами: 
| `'` после согласной | `'` после гласной |
|---------------------|-------------------|
| Смягчает гласный звук, словно `ь`. | Смягчает гласную, НО НЕ ИЗМЕНЯТ согласную перед ней. |
...
- Подробнее о приставках будет ниже.
...
| **свой**\n(или обобщённо) | **шай**     | шайашчи / шайакош (если важен род) |
...
| не уточнённая форма | частица + `-лвы/-ылв` |  |  |
